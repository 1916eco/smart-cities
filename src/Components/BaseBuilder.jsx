...
function BaseBuilder() {
  ...
  const [currentPos, setCurrentPos] = useState([57.148, -2.108]);
  ...
  const [position, setPosition] = useState([57.148, -2.108])
  ...
  return (
    ...
    <Form.Group className='' controlId='formEmail'>
        ...
        <Form.Control type='name' placeholder='Enter Home Name' onChange={(e)=>setName(e.target.value)}></Form.Control>
    </Form.Group>
    <div className='d-grid gap-2 mt-3'><Button variant='primary' type='Submit'>Add New Home</Button></div>
    </Form>
    {position}
    </div>
    </div>
