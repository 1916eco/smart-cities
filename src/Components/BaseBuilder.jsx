...
function BaseBuilder() {
  ...
  useEffect(()=>{if(!user)navigate("/");console.log(user)},[])
  ...
  return (
    ...
    <Form.Group className='' controlId='formEmail'>
        ...
        <Form.Control type='name' placeholder='Enter Home Name' required={true} onChange={(e)=>setName(e.target.value)}></Form.Control>
    </Form.Group>
