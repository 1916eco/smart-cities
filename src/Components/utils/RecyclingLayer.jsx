...
function RecyclingLayer() {
  ...
  //console.log(something)
    ...
    <Marker icon={RecycleIcon} key={point.attributes.OBJECTID} position={[point.geometry.points[0][1],point.geometry.points[0][0]]}>
      <Popup>
      {point.attributes.SITE} <br/>{point.attributes.LOCALITY}<br/>{point.attributes.ROADNAME}
      </Popup>
    </Marker>
  ))}
</div>
